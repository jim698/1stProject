...
public class PmodifyService implements Service {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		String dbpphoto = mRequest.getParameter("dbpphoto");
		String dbpphoto2 = mRequest.getParameter("dbpphoto2");
		...
		String pphoto = image[0] != null ? image[0] : dbpphoto;
		String pphoto2 = image[2] != null ? image[2] : dbpphoto2;
		...
		pDao.modifyProduct(pname, pphotologo, pphoto, pphoto2, pcontent, pcnt, pprice, pdiscount, pno);
