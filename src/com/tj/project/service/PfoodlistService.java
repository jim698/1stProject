...
public class PfoodlistService implements Service {

	@Override
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		String pageNum = request.getParameter("pageNum");
		String pkinds = request.getParameter("pkinds");
		...
		request.setAttribute("pfoodList", pDao.getAllPkindsProducts(startRow, endRow, pkinds));
