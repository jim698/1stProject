...
public class OrderAllListService implements Service {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		request.setAttribute("orderAllList", oDao.getAllOrders(startRow, endRow));

		int totCnt = oDao.getAllOrdersTotCnt();
